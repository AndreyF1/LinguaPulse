  ...
  try {
    ...
    if (beginnerState.scene === 1) {
      ...
      if (hasFineGreat) {
        ...
        await sendText(
          chatId,
          "Главное в изучении языка — это регулярность. Лучше 15 минут сфокусированной практики каждый день, чем 2 часа раз в неделю. Это помогает держать мозг в тонусе и стабильно двигаться вперед.\n\nПодписка LinguaPulse — это твой личный \"спортзал\" для английского. Каждый день тебя будет ждать полноценный диалог с AI-тренером и детальный разбор твоих ответов, чтобы ты видел(а) свои ошибки и точки роста.\n\nВот как работает подписка:\n\nСтандартная цена — 1500 ₽/месяц.\n\nНо для тебя, как для нового пользователя, первый месяц — всего за 600 ₽!\n\nОтменить можно в любой момент.\n\nПри нажатии на кнопку ты перейдешь на защищенную страницу оплаты Tribute. Не пугайся, если увидишь полную цену — с тебя спишется только 600 ₽ за первый месяц.",
          env,
          [[
            { text: "✅ Начать за 600₽", url: tributeAppLink },
