...
const supabaseUrl = 'https://qpqwyvzpwwwyolnvtglw.supabase.co'; // Replace with your Supabase project URL

// The `anon` key for your project. This key is safe to use in a browser.
// It should be a very long string of random characters.
const supabaseAnonKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InFwcXd5dnpwd3d3eW9sbnZ0Z2x3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTY0ODc4NzksImV4cCI6MjA3MjA2Mzg3OX0.7d8HoIu_-hD4VxUnWerXmik19aVl8YeUpb45A08O698'; // Replace with your Supabase public anon key
